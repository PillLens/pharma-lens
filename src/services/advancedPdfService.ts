...
class AdvancedPDFService {
  ...
  async generateMedicalReport(
    ...
    if (includeQR) {
      this.addVerificationElements(data);
    }
  ...
  private addMedicalLetterhead(providerInfo?: HealthcareProviderInfo) {
    ...
    this.doc.text('Care Capsule Scribe', pageWidth / 2, 20, { align: 'center' });
  ...
  private addDocumentMetadata(data: MedicationReportData) {
    ...
    this.doc.text(`Generated by: ${data.generatedBy || 'Care Capsule Scribe'}`, rightX, 79, { align: 'right' });
  }
  ...
  private addVerificationElements(data: MedicationReportData) {
    ...
    this.doc.text('Digitally signed and verified by Care Capsule Scribe', 20, yPos);
    
    // QR Code for verification (placeholder)
    this.doc.setDrawColor(0, 0, 0);
    this.doc.rect(20, yPos + 5, 30, 30);
    this.doc.setFontSize(8);
    this.doc.text('QR Code for', 22, yPos + 15);
  ...
  private addReportFooter(data: MedicationReportData) {
    ...
    this.doc.setFontSize(8);
    this.doc.setFont('helvetica', 'italic');
    const disclaimer = 'This report is generated by Care Capsule Scribe. Please consult with your healthcare provider before making any medication changes.';
