...
const MobileTabNavigation: React.FC = () => {
  ...
  return (
    <>
      <nav className="fixed left-0 right-0 z-50 md:hidden bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-t border-slate-200/50 dark:border-slate-700/50 shadow-lg will-change-transform bottom-nav">
