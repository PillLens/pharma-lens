        ...
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-medical flex items-center justify-center shadow-soft">
            ...
            <MobileCardTitle className="text-base mb-1 line-clamp-1">
