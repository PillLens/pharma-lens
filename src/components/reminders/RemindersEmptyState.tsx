          ...
          <div className="relative mb-6">
            <div className="flex items-center justify-center mb-4">
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-medical-warning/20 flex items-center justify-center">
                  <Clock className="w-3 h-3 text-medical-warning" />
                </div>
              </div>
            </div>
          </div>
