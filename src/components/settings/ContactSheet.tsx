...
export const ContactSheet: React.FC<ContactSheetProps> = ({
  ...
  const handleEmailContact = () => {
    const subject = encodeURIComponent(t('legal.emailSubject'));
    const body = encodeURIComponent(t('legal.emailBody'));
          ...
          <div className="space-y-6 pb-6">
            ...
            <div className="p-4 bg-background border border-border rounded-lg">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-base font-semibold text-foreground">{t('legal.emailSupportTitle')}</h3>
              </div>
              <p className="text-sm text-muted-foreground mb-4">
                {t('legal.emailSupportDescription')}
              </p>
            ...
            <div className="p-4 bg-muted/50 rounded-lg">
              <h4 className="text-sm font-semibold text-foreground mb-2">{t('legal.helpTopicsTitle')}</h4>
            ...
            <div className="p-4 bg-primary/5 border border-primary/20 rounded-lg">
              <p className="text-xs text-muted-foreground">
                <strong>{t('legal.emergencyNoticeTitle')}:</strong> {t('legal.emergencyNotice')}
              </p>
            </div>
          </div>
        </ScrollArea>
