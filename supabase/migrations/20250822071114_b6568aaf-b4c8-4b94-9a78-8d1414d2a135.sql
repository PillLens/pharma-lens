...
('650e8400-e29b-41d4-a716-446655440001', 'Concor', 'Bisoprolol', '5mg', 'Tablet', 'Merck KGaA', '4250451600005', 'C07AB07', '["Bisoprolol fumarate"]', 'Beta-blocker', '["Do not stop suddenly", "Monitor heart rate", "Avoid in severe asthma"]', 'AZ', 'verified', true, 'official', '["bisoprolol", "concor", "beta blocker", "heart", "blood pressure"]'),

('650e8400-e29b-41d4-a716-446655440002', 'Prestarium', 'Perindopril', '5mg', 'Tablet', 'Servier', '3400936404052', 'C09AA04', '["Perindopril arginine"]', 'ACE inhibitor', '["Monitor kidney function", "Avoid in pregnancy", "May cause dry cough"]', 'AZ', 'verified', true, 'official', '["perindopril", "prestarium", "ace inhibitor", "hypertension"]'),

('650e8400-e29b-41d4-a716-446655440003', 'Amlodipine', 'Amlodipine', '10mg', 'Tablet', 'Actavis', '8594003333333', 'C08CA01', '["Amlodipine besylate"]', 'Calcium channel blocker', '["May cause ankle swelling", "Avoid grapefruit juice", "Monitor blood pressure"]', 'AZ', 'verified', true, 'official', '["amlodipine", "calcium channel blocker", "hypertension", "angina"]'),

-- Diabetes medications
('650e8400-e29b-41d4-a716-446655440004', 'Glucophage', 'Metformin', '850mg', 'Tablet', 'Merck Serono', '3400938745621', 'A10BA02', '["Metformin hydrochloride"]', 'Antidiabetic', '["Take with food", "Monitor kidney function", "Risk of lactic acidosis"]', 'AZ', 'verified', false, 'official', '["metformin", "glucophage", "diabetes", "blood sugar"]'),

('650e8400-e29b-41d4-a716-446655440005', 'NovoRapid', 'Insulin Aspart', '100 units/ml', 'Injection', 'Novo Nordisk', '5909991234567', 'A10AB05', '["Insulin aspart"]', 'Rapid-acting insulin', '["Monitor blood glucose", "Rotate injection sites", "Risk of hypoglycemia"]', 'AZ', 'verified', true, 'official', '["insulin", "novorapid", "diabetes", "injection", "rapid acting"]'),

-- Respiratory medications
('650e8400-e29b-41d4-a716-446655440006', 'Ventolin', 'Salbutamol', '100mcg/dose', 'Inhaler', 'GSK', '5000169274282', 'R03AC02', '["Salbutamol sulfate"]', 'Bronchodilator', '["Shake before use", "Rinse mouth after use", "Do not exceed 8 puffs per day"]', 'AZ', 'verified', false, 'official', '["salbutamol", "ventolin", "asthma", "inhaler", "bronchodilator"]'),

('650e8400-e29b-41d4-a716-446655440007', 'Symbicort', 'Budesonide + Formoterol', '160mcg/4.5mcg', 'Inhaler', 'AstraZeneca', '7311518170123', 'R03AK07', '["Budesonide", "Formoterol fumarate"]', 'Corticosteroid + Bronchodilator', '["Rinse mouth after use", "Not for acute attacks", "Monitor for thrush"]', 'AZ', 'verified', true, 'official', '["budesonide", "formoterol", "symbicort", "asthma", "copd"]'),

-- Antibiotics
('650e8400-e29b-41d4-a716-446655440008', 'Augmentin', 'Amoxicillin + Clavulanic acid', '625mg', 'Tablet', 'GSK', '5000169161234', 'J01CR02', '["Amoxicillin trihydrate", "Clavulanic acid"]', 'Antibiotic', '["Complete full course", "Take with food", "May cause diarrhea"]', 'AZ', 'verified', true, 'official', '["amoxicillin", "clavulanic", "augmentin", "antibiotic", "infection"]'),

('650e8400-e29b-41d4-a716-446655440009', 'Azithromycin', 'Azithromycin', '500mg', 'Tablet', 'Sandoz', '5909873456789', 'J01FA10', '["Azithromycin dihydrate"]', 'Macrolide antibiotic', '["Take on empty stomach", "Complete full course", "May interact with heart medications"]', 'AZ', 'verified', true, 'official', '["azithromycin", "macrolide", "antibiotic", "infection"]'),

-- Pain relief
('650e8400-e29b-41d4-a716-446655440010', 'Panadol', 'Paracetamol', '500mg', 'Tablet', 'GSK', '5000169345678', 'N02BE01', '["Paracetamol"]', 'Analgesic/Antipyretic', '["Do not exceed 4g daily", "Avoid alcohol", "Risk of liver damage with overdose"]', 'AZ', 'verified', false, 'official', '["paracetamol", "panadol", "pain", "fever", "acetaminophen"]'),

-- Gastrointestinal
('650e8400-e29b-41d4-a716-446655440011', 'Omeprazole', 'Omeprazol', '20mg', 'Capsule', 'Krka', '3838989876543', 'A02BC01', '["Omeprazole magnesium"]', 'Proton pump inhibitor', '["Take before meals", "May affect vitamin B12 absorption", "Risk of bone fractures with long-term use"]', 'AZ', 'verified', false, 'official', '["omeprazole", "ppi", "acid reflux", "stomach", "gastritis"]'),

-- Psychiatric medications
('650e8400-e29b-41d4-a716-446655440012', 'Sertraline', 'Sertralin', '50mg', 'Tablet', 'Pfizer', '0069458012345', 'N06AB06', '["Sertraline hydrochloride"]', 'SSRI Antidepressant', '["May take 4-6 weeks to work", "Do not stop suddenly", "Monitor for suicidal thoughts"]', 'AZ', 'verified', true, 'official', '["sertraline", "ssri", "antidepressant", "depression", "anxiety"]');
